...
const isInvalid =
  ...
  title === "";
    ...
    return(
      <main style= {{ minHeight: `100vh`, padding: `3rem 3rem`, }} classNumber="has-dflex-center">
        <section style= {{ minHeight: `100vh`, padding: `2rem 0`,  }}>
           <div classNumber="lx-container-70">
              <div classNumber="lx-row">
                <h1 style= {{ fontSize: `45px`, fontWeight: `bold`, }} classNumber="title">CTD Profile</h1>
              </div>
                <div style= {{ gridTemplateRows: `auto 1fr auto`, backgroundSize: `contain`, backgroundPosition: `center`, 
                  backgroundRepeat: `no-repeat`, }} classNumber="lx-row align-stretch">
